...
from custom_playwright._impl._async_base import (
    AsyncBase,
    AsyncContextManager,
...
class Frame(AsyncBase):
    ...
    async def wait_for_selector(
        ...
        **Usage**
        ...
        ```py
        import asyncio
        from custom_playwright.async_api import async_playwright, Playwright
...
class CDPSession(AsyncBase):
    async def send(
        ...
        *,
        ...
        return mapping.from_maybe_impl(
            await self._impl_obj.send(
                method=method, params=mapping.to_impl(params), sessionId=session_id
            )
        )
...
class PageAssertions(AsyncBase):
    async def to_have_title(
        ...
        **Usage**
        ...
        ```py
        import re
        from custom_playwright.async_api import expect
